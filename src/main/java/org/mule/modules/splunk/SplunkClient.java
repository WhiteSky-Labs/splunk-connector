...
public class SplunkClient {
     ...
     *
     * @param strategy The ConnectionManagementStrategy used to connect to the Splunk Server
	 * @throws ConnectionException on invalid credentials
     */
     ...
     * @throws SplunkConnectorException on invalid results
     */
     ...
     * Set the service
     * 
     * @param service The Splunk service
     */
...
//        return Inflector.getInstance().lowerCamelCase(key).replace("_", "");
     ...
     * @throws SplunkConnectorException on failed or interrupted transfer
     */
